...
fun ProfileEditBottomSheet(
    ...
    onTextFieldValueChanged: (String, EditableFieldType) -> Unit,
    ...
    ModalBottomSheet(
        ...
        Column(modifier=modifier.fillMaxWidth()) {
            ...
            TextField(
                ...
                onValueChange = {
                    onTextFieldValueChanged(it,fieldType)
                },
                modifier= Modifier
            ...
            Row(
                ...
                TextButton(
                    onClick = {
                        ...
                        onCancelButtonClicked(fieldType)
                    }
                ) {
                    Text(text = "Cancel", fontSize = 12.sp, fontWeight = FontWeight.Medium, color = bodyTextLightColor)
                }

                TextButton(
                    onClick = {
                        coroutineScope.launch { sheetState.hide() }
                        onSaveButtonClicked(fieldType)
                    }
                ) {
                    Text(text = "Save", fontSize = 12.sp, fontWeight = FontWeight.Medium, color = bodyTextLightColor)
                }
            }
        }
    }
